...
public class MainActivity extends Activity {
	...
	public void integralizar(View view){
		...
		dialog = ProgressDialog.show(this, "Integralizando...", "Aguarde enquanto processamos a integraliza̤̣o...");
	...
	private class LongOperation extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	if (result != null) {
        		...
        		Toast t = Toast.makeText(MainActivity.this, "Ocorreu um erro de conex̣o.", Toast.LENGTH_LONG);
        		t.show();
        	}
        	dialog.dismiss();
        }
